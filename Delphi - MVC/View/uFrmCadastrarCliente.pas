...
type
  ...
  public
    ...
    procedure PreencheTela(objCliente:TCliente);
  end;
...
procedure TfrmCadastrarCliente.HabilitarControles(aOperacao: TOperacao);
  procedure HabilitarNovoAlterar;
  begin
...
begin
  case aOperacao of
    opNovo, opAlterar :HabilitarNovoAlterar;
    opNavegar:HabilitarNavegar;
  end;
end;
...
procedure TfrmCadastrarCliente.PreencheTela(objCliente: TCliente);
begin
  edtCodigo.Text := IntToStr(objCliente.ID);
  edtNome.Text := objCliente.Nome;
  cbxTipo.Text := objCliente.Tipo;
  edtDocumento.Text := objCliente.Documento;
  edtTelefone.Text := objCliente.Telefone;
end;

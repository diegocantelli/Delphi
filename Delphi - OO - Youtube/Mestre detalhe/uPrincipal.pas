...
type
  TForm1 = class(TForm)
    ...
    procedure dbGridDestinoDblClick(Sender: TObject);
  private
...
procedure TForm1.dbGridDestinoDblClick(Sender: TObject);
begin
  MovimentaRegistro(dbGridDestino, ClientDataSet1);
  ExcluiRegistroOrigem(dbGridDestino);
  AtualizaGrid(dbGridDestino);
end;

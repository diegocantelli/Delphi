...
type
  ...
  public
    ...
    function RetornaNome:String; virtual;{indica que essa função pode ser reescrita em outra classe filha}
    function MetodoAbstrato:String; virtual; abstract;{não pode ser implementado na classe mãe} 
  end;
...
begin
  Nome := 'TPessoa';
//  Result:= 'Essa é a classe TPessoa';
end;

...
begin
  // implementa o metodo ConsultarPrazo da interface IFactoryMethod
  FabricaPrazos := TFabricaPrazos.Create;

  // retorna uma instancia da interface iTipoPrazo.
  // É possível fazer essa inferencia pois as classes PrazoMensal e PrazoAnual
  // implementam a interface iTipoPrazo
  // O método ConsultarPrazo retorna uma instancia da classe com base no parametro
  // informado pela classe.

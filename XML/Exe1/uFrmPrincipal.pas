...
{TODO -c:Excluir e editar nós do xml}
...
var
  ...
  I, ISubNode:Integer;
  NoPrincipal,Pessoas:IXMLNode;
begin

  NoPrincipal := XMLDocument1.DocumentElement;
  Pessoas := NoPrincipal.ChildNodes.FindNode('AVISO').ChildNodes.FindNode('PESSOA');

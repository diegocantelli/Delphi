...
type
  TFornecedoresDAO = class
    ...
    public
      ...
      procedure RetornaFornecedor(FornecedoresModel:TFornecedorModel;
                                  Cod: Integer=0;
                                  Fantasia :String='';
...
begin
  ...
  Qry.SQL.Add(' update fornecedor set raz_soc = :raz_soc, fantasia = :fantasia, '
                                 ...
                                 +' id_cidade = :id_cidade, '
                                 +' id_estado = :id_estado  '
             +' where id_forncecedor = :id_fornecedor ');
  Qry.ParamByName('id_fornecedor').AsInteger  := Modelo.Id;
...
procedure TFornecedoresDAO.RetornaFornecedor(FornecedoresModel:TFornecedorModel;
                                            Cod: Integer=0;
                                            Fantasia :String='';
                                            Cnpj: string='');
  var
